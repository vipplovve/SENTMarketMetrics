...
for sentence in Data:
    ...
    SentenceEmbedding = numpy.array([SentenceEmbeddings(sentence, Encoder, 300)]);

    FinalDataframe = pandas.DataFrame(SentenceEmbedding);
        
    Probability = Model.predict(FinalDataframe);
